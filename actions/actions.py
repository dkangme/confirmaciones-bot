...
class ActionProcessDateRequest(Action):
        ...
        try:
            ...
            if fecha and hora:
                ...
                if start_time and end_time:
                    ...
                    # Llamar a la función get_slots_optimized
                    slots_response = self._call_get_slots_optimized(tracker)
                    
                    if slots_response:
                        # Procesar los slots disponibles
                        from .rebooking_actions import process_available_slots
    ...
    def _call_get_slots_optimized(self, tracker: Tracker) -> Dict:
        ...
        """
        try:
            from .rebooking_actions import get_slots_optimized
            
            # Obtener parámetros de los slots
            resource_id = get_slot_value(tracker, "resource_name")
            ...
            finish_time = get_slot_value(tracker, "end_time")
            ...
            required_params = [resource_id, service_id, start_time, finish_time, patient_id]
            ...
            logger.info(f"Llamando get_slots_optimized con:")
